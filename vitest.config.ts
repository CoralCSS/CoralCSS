  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/plugins/core/utilities/index.ts',
        'src/plugins/core/variants/index.ts',
        ...
        // DevTools utilities - complex tooling better covered by integration tests
        'src/devtools/analyzer.ts',
        'src/devtools/class-mapper.ts',
        'src/devtools/tailwind-converter.ts',
        'src/devtools/transformer.ts',
        'src/devtools/types.ts',
        // Build tools with complex file I/O - better covered by integration tests
        'src/build/postcss.ts',
        'src/build/esbuild.ts',
        // Core worker has complex async behavior
        'src/core/worker.ts',
      ],
      thresholds: {
        lines: 93,
