 ...
 * Color Palettes
 *
 * Complete color palette definitions for CoralCSS.
 * @module theme/colors
 */

import type { ColorScale, ThemeColors } from '../types'

/**
 * Coral brand color palette (primary)
 */
