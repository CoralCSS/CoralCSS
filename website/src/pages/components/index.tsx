...
const categories = [
  {
    ...
    count: 50,
    components: ['Button', 'IconButton', 'ButtonGroup', 'ToggleButton', 'CopyButton', 'SplitButton', 'FloatingButton', 'LikeButton', 'ShareButton', 'GradientButton', 'NeonButton', 'PulseButton']
  },
  {
    id: 'forms',
    name: 'Forms',
    ...
    count: 64,
    components: ['Input', 'Textarea', 'Select', 'Checkbox', 'Radio', 'Switch', 'Slider', 'RangeSlider', 'NumberInput', 'PinInput', 'ColorPicker', 'DatePicker']
  },
  {
    id: 'data-display',
    name: 'Data Display',
    ...
    count: 44,
    components: ['Card', 'Avatar', 'Badge', 'Table', 'Accordion', 'Timeline', 'Progress', 'Skeleton', 'Stat', 'List', 'Calendar', 'Comment']
  },
  {
    id: 'feedback',
    name: 'Feedback',
    ...
    count: 47,
    components: ['Alert', 'Toast', 'Notification', 'Banner', 'Spinner', 'Progress', 'ProgressRing', 'EmptyState', 'ErrorBoundary', 'StatusIndicator', 'Snackbar', 'ProgressBar']
  },
  {
    id: 'overlays',
    name: 'Overlays',
    ...
    count: 36,
    components: ['Dialog', 'Modal', 'Drawer', 'Sheet', 'Popover', 'Tooltip', 'Dropdown', 'ContextMenu', 'Lightbox', 'AlertDialog', 'HoverCard', 'ImageGallery']
  },
  {
    id: 'navigation',
    name: 'Navigation',
  ...
  },
  {
    ...
    count: 41,
    components: ['Container', 'Grid', 'Flex', 'Stack', 'Divider', 'Spacer', 'AspectRatio', 'Center', 'Masonry', 'Resizable', 'Splitter', 'ScrollArea']
  },
  {
    id: 'typography',
    name: 'Typography',
    ...
    count: 32,
    components: ['Heading', 'Text', 'Blockquote', 'Highlight', 'Code', 'Gradient', 'Truncate', 'Prose', 'List', 'Link', 'Label', 'DescriptionList']
  },
  {
    id: 'media',
    name: 'Media',
    ...
    count: 29,
    components: ['Image', 'Video', 'Audio', 'Figure', 'Icon', 'QRCode', 'EmojiPicker', 'Iframe', 'Barcode', 'GifPicker', 'MediaPlayer', 'AvatarGroup']
  },
  {
    id: 'charts',
    name: 'Charts',
    ...
    count: 37,
    components: ['BarChart', 'LineChart', 'PieChart', 'DonutChart', 'AreaChart', 'Sparkline', 'Gauge', 'Meter', 'Heatmap', 'RadarChart', 'ScatterPlot', 'TimelineChart']
  },
  {
    id: 'advanced',
    name: 'Advanced',
    ...
    count: 33,
    components: ['Command', 'Carousel', 'Marquee', 'Kbd', 'Spotlight', 'Tour', 'Onboarding', 'Hotkeys', 'Portal', 'FocusTrap', 'VirtualList', 'ImageComparison']
  },
  {
    id: 'dashboard',
    name: 'Dashboard',
    ...
    icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
    count: 35,
    components: ['StatsCard', 'MetricCard', 'Counter', 'ProgressRing', 'ActivityFeed', 'KPIWidget', 'SalesChart', 'TeamOverview', 'RecentOrders', 'NotificationPanel', 'GoalTracker', 'PerformanceMeters']
  },
  {
    id: 'modern-css',
    name: 'Modern CSS',
    ...
    count: 35,
    components: ['Card3D', 'ContainerQuery', 'AnchorPosition', 'ScrollTimeline', 'ViewTransition', 'HasSelector', 'SubGrid', 'WideGamutColors', 'EntryAnimations', 'FieldSizing', 'TextWrap', 'LightDark']
  },
  {
    id: 'ecommerce',
    name: 'E-commerce',
    description: 'Shopping cart, product cards, checkout flow, and components for online stores.',
    icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z',
    count: 18,
    components: ['ProductCard', 'ShoppingCart', 'PriceTag', 'QuantitySelector', 'CartIcon', 'ProductGallery', 'CheckoutSteps', 'PaymentMethod', 'OrderSummary', 'CouponInput', 'WishlistButton', 'ProductBadge', 'SizeSelector', 'ColorSwatch', 'ReviewStars', 'StockIndicator', 'ShippingEstimate', 'ProductFilters']
  },
  {
    id: 'chat',
    name: 'Chat & Communication',
    description: 'Chat bubbles, message inputs, typing indicators for real-time messaging.',
    icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z',
    count: 17,
    components: ['ChatBubble', 'TypingIndicator', 'MessageInput', 'ChatList', 'MessageReactions', 'VoiceMessage', 'MessageStatus', 'ChatHeader', 'MessageGroup', 'DateSeparator', 'ImageMessage', 'FileMessage', 'OnlineIndicator', 'ReplyPreview', 'VideoCallButton', 'ChatNotification', 'ReadReceipts']
  },
  {
    id: 'ai',
    name: 'AI & ML UI',
    description: 'Prompt inputs, streaming outputs, model selectors for AI-powered interfaces.',
    icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z',
    count: 18,
    components: ['PromptInput', 'StreamingText', 'ModelSelector', 'TokenCounter', 'AIMessage', 'AICodeBlock', 'ThinkingIndicator', 'SuggestionChips', 'ResponseActions', 'ContextFile', 'ConversationHistory', 'SystemPrompt', 'ParameterSlider', 'StopButton', 'CostEstimate', 'ModelComparison', 'ImageGeneration', 'AIErrorMessage']
  },
  {
    id: 'files',
    name: 'File Management',
    description: 'File browsers, upload zones, folder trees for file management interfaces.',
    icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z',
    count: 15,
    components: ['FileBrowser', 'FileUpload', 'UploadProgress', 'FileCard', 'FolderTree', 'FilePreview', 'StorageMeter', 'FileTypeIcon', 'BreadcrumbPath', 'FileActions', 'SearchFiles', 'RecentFiles', 'FileDetails', 'ShareDialog', 'EmptyFolder']
  },
  {
    id: 'landing',
    name: 'Landing Page',
    description: 'Complete landing page showcase with hero, features, testimonials, pricing, and CTA sections.',
    icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6',
    count: 1,
    components: ['LandingPageShowcase']
  },
  {
    id: 'portfolio',
    name: 'Portfolio',
    description: 'Modern portfolio page with hero section, project showcase, skills, and contact form.',
    icon: 'M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z',
    count: 1,
    components: ['PortfolioPageShowcase']
  },
  {
    id: 'blog',
    name: 'Blog',
    description: 'Modern blog page with hero section, featured posts, article grid, categories, and newsletter signup.',
    icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z',
    count: 1,
    components: ['BlogPageShowcase']
  },
  {
    id: 'docs',
    name: 'Documentation',
    description: 'Comprehensive documentation page with sidebar navigation, search, code blocks, and interactive examples.',
    icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253',
    count: 1,
    components: ['DocsPageShowcase']
  },
]
